...
# Frative: shared base for internal, bearer-token-protected endpoints (not part
# of the public Canvas API) used by miaula-core-backend's provisioning Workflow.
module Internal
